...
<CodeSlide
  ...
  steps={[
    ...
    { range: [4, 4], title: 'Space', notes:  'Used for margin and padding scales' },
    { range: [4, 4], title: 'Space', notes: 'Recommended to use powers of two to ensure alignment when used in nested elements' },
    { range: [4, 4], title: 'Space', notes: 'Numbers are converted to px' },
    { range: [5, 22], title: 'Typographic Scales', notes: '' },
    { range: [23, 32], title: 'Border Styles', notes: '' },
    { range: [33, 35], title: 'Sizing', notes: 'Also supports min/max' },
    { range: [36, 60], title: 'Color', notes: 'Nested objects work as well' },
    { range: [36, 60], title: 'Color', notes: 'Arrays can be used for scales of colours' },
    { range: [105, 114], title: 'Apply the theme', notes: 'Use ThemeProvider' },
  ]}
/>
